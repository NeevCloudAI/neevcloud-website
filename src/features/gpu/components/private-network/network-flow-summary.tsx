import { FlowBand } from "@/features/gpu/components/private-network/flow-band";
import {
  FLOW_SUMMARY_BADGE_TEXT,
  FLOW_SUMMARY_REGION_TEXT,
} from "@/features/gpu/data/private-network-section-data";
...
export function NetworkFlowSummary() {
  return (
    <div className="mt-4 flex flex-1 flex-col items-center justify-start gap-2 md:gap-6">
      <Text as="small" className="w-fit rounded-full bg-primary px-4 py-1 text-white">
        {FLOW_SUMMARY_BADGE_TEXT}
      </Text>
