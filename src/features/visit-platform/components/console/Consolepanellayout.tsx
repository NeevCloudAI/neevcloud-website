...
/**
 * Shared layout for all console section tabs.
 * Renders a two-column grid: left = step content, right = UI mockup panel.
 */
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-25 items-center w-full mt-10 px-10">
      ...
      <div>
        ...
        <Text as="h3" weight="semibold" className="mt-4 text-[30px] md:text-[32px]">
          {heading}
        </Text>
        ...
        <ul className="mt-7.5 flex flex-col gap-1">
          {bullets.map((bullet) => (
            <li key={bullet.label} className="flex items-start gap-1 bg-white py-2.5 pl-3.5 max-w-md rounded-md">
            <Text as="span" textColor="primary">•</Text>
