  ...
  return (
    <section className="relative bg-white py-[3vh] md:py-[10vh] bg-glow-terminal">
      <Container className="flex flex-col items-center justify-center">
        ...
        <Text align="center" className="mt-2 block md:hidden">
        ...
        <Text align="center" className="mt-2 hidden md:block">
          From Kimi K2 to Llama 3 405B to GLM 4.5, every model runs on
          NeevCloud&apos;s GPU clusters in India and
        </Text>
        <Text align="center" className="hidden md:block">
          and is served through a unified API. Switch models with a single
          parameter change.
        </Text>
