  ...
  return (
    ...
    >
      ...
      <video
        ...
        className="absolute inset-0 h-full w-full origin-center translate-x-[20%] -translate-y-[12%] scale-[0.75] object-cover object-center [mask-image:linear-gradient(to_left,transparent_0%,#000_16%)]"
      >
