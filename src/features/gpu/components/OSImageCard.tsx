...
import type { OsCardChip, OsImageCard } from "@/features/gpu/data/os-image-section-types";

type OSImageCardProps = Pick<OsImageCard, "title" | "description" | "image" | "cards"> & {
  isSelected: boolean;
...
const OSImageCard = memo(function OSImageCard({
  ...
  return (
    ...
    >
      ...
      <Divider orientation="horizontal" className="my-4 bg-gray-60 rounded-md" />
