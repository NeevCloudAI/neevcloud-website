...
import { OFFERS_SECTION_ITEMS } from "../data/offers-section.data";

const OffersAiSection = () => {
  return (
    <section
      className="relative bg-cloud-gray py-8 md:py-16 2xl:py-25"
      aria-labelledby="offers-ai-section-heading"
      id="offers-ai-section"
    >
      <Container className="flex flex-col items-center justify-center">
        <Text
          as="h2"
          id="offers-ai-section-heading"
          textColor="black"
          align="center"
          className="max-w-4xl"
        >
...
export default OffersAiSection;
