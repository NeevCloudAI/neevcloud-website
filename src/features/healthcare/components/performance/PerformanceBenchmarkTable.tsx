...
const PerformanceBenchmarkTable = () => {
  return (
    <div className="mt-4 w-full overflow-x-auto rounded-lg border border-white-10 bg-white-5 backdrop-blur-md md:mt-10">
      <table
      ...
      <Text
        as="small"
        textColor="gray-85"
        className="block border-t border-white-10 p-4 md:px-8.75 md:py-5"
      >
        {HEALTHCARE_PERFORMANCE_DISCLAIMER}
      </Text>
    </div>
