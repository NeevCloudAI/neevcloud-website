...
export default function HeroBgVideoClient() {
  ...
  return (
    <video
      ...
      className="absolute -left-[123px] top-[238px] h-[490px] w-[575px] max-w-none origin-center object-cover lg:inset-0 lg:left-0 lg:top-0 lg:h-full lg:w-full lg:translate-x-[12%] lg:-translate-y-[7%] lg:scale-[0.75] lg:object-center lg:[mask-image:linear-gradient(to_left,transparent_0%,#000_16%)]"
    >
      {ready && (
