...
import { GPU_INSTANCE_FAMILY_OPTIONS } from "../data/transparent-pricing-section.data";
import type { GpuTransparentPricingModelFamilySidebarProps } from "../types/transparent-pricing-section.types";

const GpuTransparentPricingModelFamilySidebar = ({
  activeFamily,
  onFamilySelect,
  ...
  return (
    <div>
      ...
      <div
        ...
        aria-label="GPU instance family tabs"
        className="mt-4"
      >
        <ul className="flex list-none flex-col gap-1.5">
          {GPU_INSTANCE_FAMILY_OPTIONS.map((option) => {
...
export default GpuTransparentPricingModelFamilySidebar;
