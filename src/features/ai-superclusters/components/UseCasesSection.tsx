...
import { AI_SUPERCLUSTERS_USE_CASES } from "../data/use-cases.data";

const UseCasesSection = () => {
  return (
    <section
      className="relative bg-cloud-gray py-8 md:py-16 2xl:py-25"
      aria-labelledby="ai-superclusters-use-cases-heading"
    >
      <Container>
        <Text as="h2" align="center" id="ai-superclusters-use-cases-heading">
        ...
        <div className="mt-6 md:mt-12.5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {AI_SUPERCLUSTERS_USE_CASES.map((useCase) => (
