...
export const GPU_PRICING_FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "GPU AI Service: Container-native, Kubernetes-managed pods. GPU VM Service: Full Linux VMs with complete OS control. Same GPU hardware, different deployment models. Choose based on your team's workflow.",
  },
  {
    id: 2,
    category: "Billing",
