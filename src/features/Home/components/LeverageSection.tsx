        ...
        <ul className="grid list-none gap-4 lg:grid-cols-3">
          {LEVERAGE_ROWS.map((row) => (
            <li
              ...
              className="flex min-h-[320px] flex-col justify-between gap-10 bg-white p-4 lg:min-h-[443px] lg:p-6"
            >
              <div className="flex flex-col gap-4">
                <LeverageStatClient value={Number(row.stat)} unit={row.unit} />
                <p className="text-[18px] font-medium leading-[142%] tracking-[-0.02em] lg:text-[20px]">
                  <span className="block text-[18px] font-medium text-[#01A78B] lg:text-[20px]">
                    {row.titleTeal}
                  </span>
                  <span className="block text-[18px] font-medium text-black lg:text-[20px]">
                    {row.titleRest}
                  </span>
                </p>
