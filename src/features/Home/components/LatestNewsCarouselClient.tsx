...
export default function LatestNewsCarouselClient() {
  return (
    <ul className="flex list-none snap-x snap-mandatory gap-4 overflow-x-auto pb-1 [&::-webkit-scrollbar]:hidden [mask-image:linear-gradient(to_right,#000_0%,#000_90%,transparent_100%)]">
