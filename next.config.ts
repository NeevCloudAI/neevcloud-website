...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      {
        source: "/h200-gpu-cluster/",
        destination: "/nvidia-h200",
        permanent: true,
      },
      {
        source: "/h200-gpu-cluster",
      ...
      {
        source: "/h100-gpu-cluster/",
        destination: "/nvidia-h100",
        permanent: true,
      },
      {
        source: "/h100-gpu-cluster",
      ...
      {
        source: "/ai-supercloud/ai-labs",
        destination: "/agentic-studio",
        permanent: true,
      },
      {
        source: "/inquiry-for-career.php",
        destination: "/careers",
        permanent: true,
      },
      {
        source: "/jd-full-stack-developer.php",
        destination: "/careers",
        permanent: true,
      },
      {
        source: "/neevai-Internship-program.html",
        destination: "/careers",
        permanent: true,
      },
    ];
