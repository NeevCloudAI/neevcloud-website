...
export const CPU_PRICING_SECTION_ITEMS: readonly AmbitionDetailItem[] = [
  {
    id: "container-native",
    ...
    bullets: [
      ...
      { id: 4, title: "Databases and caching layers" },
  ...
  },
  {
    ...
    description:
      "Built on sovereign Indian infrastructure. Your applications, data pipelines, and compute resources stay within India's jurisdiction.",
    bullets: [
