...
import { AI_SUPERCLUSTER_STEPS } from "../data/how-it-works.data";

const HowItWorksSection = () => {
  return (
    <section
      className="relative bg-cloud-gray py-8 md:py-16 2xl:py-25"
      aria-labelledby="ai-supercluster-how-it-works-heading"
    >
      <Container className="flex flex-col items-center justify-center">
        <Text as="h2" id="ai-supercluster-how-it-works-heading" align="center">
          From spec sheet to{" "}
        ...
        <ol className="w-full mt-6 md:mt-12.5 grid grid-cols-2 md:grid-cols-4 gap-5 list-none p-0 m-0">
          {AI_SUPERCLUSTER_STEPS.map((step) => (
            <li
              key={step.number}
